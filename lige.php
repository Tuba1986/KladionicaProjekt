  ...
  <main>
    <div class="popis-liga">
      <?php
        ...
        $sql="SELECT * FROM liga ORDER BY liga_id LIMIT ".$vel_str;
        ...
        echo "<caption style='margin-bottom: 20px;'>Popis liga sustava</caption>";
        echo "<thead><tr>
          <th>Naziv</th>
          <th>Slika</th>
          <th>Video</th>
        ...
        while(list($liga_id,$moderator_id,$naziv,$slika,$video,$opis)=mysqli_fetch_array($rs)){
          echo "<tr>
            ...
            <td><div><iframe width='100' height='100' src='$video'></iframe></div></td>
            <td>$opis</td>";
            echo "<td><a class='link' href='liga.php?liga=$liga_id'>UREDI</a></td>";
            echo "<td></td>";
          echo "</tr>";
        }
        echo "</tbody>";
        ...
        echo '<div id="paginacija">';
          if($aktivna!=1){
            $prethodna=$aktivna-1;
            echo "<a style='margin-right: 5px;' class='link' href=\"lige.php?stranica=".$prethodna."\">&lt;</a>";
          }
        ...
        if($aktivna<$broj_stranica){
          $sljedeca=$aktivna+1;
          echo "<a style='margin-right: 5px;' class='link' href=\"lige.php?stranica=".$sljedeca."\">&gt;</a>";
        }
        echo "<br/>";
          echo '<a style="margin-right: 5px;" class="link" href="liga.php">DODAJ LIGU</a>';
        echo '</div>'; 
      ?>
